					...
					Columns: []minisql.Column{
						{
							...
							Size:         1,
							Nullable:     true,
							DefaultValue: minisql.MakeBool(true),
						},
					},
				},
			},
					...
					Columns: []minisql.Column{
						{
							...
							Size:         8,
							Nullable:     true,
							DefaultValue: minisql.MakeInt8(int64(100)),
						},
					},
				},
			},
					...
					Columns: []minisql.Column{
						{
							...
							Size:         8,
							Nullable:     true,
							DefaultValue: minisql.MakeDouble(float64(0.25)),
						},
					},
				},
			},
					...
					Columns: []minisql.Column{
						{
							...
							Kind:         minisql.Text,
							Nullable:     true,
							DefaultValue: minisql.MakeVarchar(minisql.NewTextPointer([]byte("hello"))),
						},
					},
				},
			},
